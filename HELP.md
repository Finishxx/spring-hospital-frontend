...
* The original package name 'fit.cvut.cz.tjv.hospital.frontend.tjv-hospital-frontend' is invalid and this project uses 'fit.cvut.cz.tjv.hospital.frontend.tjvhospitalfrontend' instead.
